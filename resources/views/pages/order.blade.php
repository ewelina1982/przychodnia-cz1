    ...
    <div class="container-fluid bcolor">
        <div class="row">
            <div class="col text-center">
                ...
                <p>Drogi Pacjencie prosimy o wypełnienie wszystkich pól. <i>Odbiór recepty na drugi dzień roboczy.</i></p>
            ...
            <div class="col">
                <form id="order">
                    ...
                    <div class="data form-group w-50">
                        ...
                        <input type="text" name="drug" class="form-control clear" id="data" placeholder="Podaj datę yyyy-mm-dd">
                    ...
                    <div class="form-group w-50">
                        <label class="mt-2" for="many">Ilość leków</label>
                        <select id="many" class="form-control">
